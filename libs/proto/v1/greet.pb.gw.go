...
func RegisterGreeterHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GreeterServer) error {
	...
	mux.Handle("POST", pattern_Greeter_Greet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/monorepo.v1.Greeter/Greet", runtime.WithHTTPPathPattern("/greet"))
		if err != nil {
...
func RegisterGreeterHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GreeterClient) error {
	...
	mux.Handle("POST", pattern_Greeter_Greet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/monorepo.v1.Greeter/Greet", runtime.WithHTTPPathPattern("/greet"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Greeter_Greet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"greet"}, ""))
)
